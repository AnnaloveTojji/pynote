...
zip(),과 list() 함수를 이용하여, 주어진 두 리스트의 원소를 병합한 튜플의 리스트를 만드시오.'''
lst1=[19542209, 4887871, 1420491, 626299, 1805832, 39865590]
lst2=["New York", "Alabama", "Hawaii", "Vermont", "West Virginia",  "California"]
lst3=list(zip(lst1,lst2))
print(lst3)

1에서 8까지의 숫자 범위를 생성하시오. 그 다음 zip을 사용하여 주어진 리스트와 그 범위숫자(range)를 병합하여 새로운 리스트를 만드시오.'''
lst1=["Energy", "Agriculture", "Industry", "Technology", "Finance", "Forestry", "Transport"]
rng1=[1,2,3,4,5,6,7,8]
lst=list(zip(lst1,rng1))
print(lst)

zip과 dict 함수를 이용하여 lst1과 lst2의 원소를 key-value짝으로 가지는 딕셔너리를 만드시오.'''
lst1=["Netflix", "Hulu", "Sling", "Hbo"]
lst2=[198, 166, 237, 125]
points=dict(zip(lst1,lst2))
print(points)

zip, list, sorted 함수를 이용하여,  lst1과 lst2의 원소로 만든 튜플로 이루어진 정렬된 리스트를 생성하시오.'''
